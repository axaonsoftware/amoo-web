  ...
  return (
    <>
      <nav className="flex items-center gap-[6px] text-[10.5px]">
        ...
        <span className="text-[#8B879C]">Report Management</span>
        <ChevronRight size={12} className="text-[#B7B3C4]" />
        <span className="font-medium text-[#3D3752]">All Reports</span>
      </nav>
        ...
        <div className="flex items-center gap-[14px]">
          ...
          <div>
            ...
            <p className="mt-[7px] text-[11px] text-[#8B879C]">
              View, create, edit, and manage all reports across all types.
            </p>
          </div>
        </div>
