...
const nav: { label: string; Icon: React.ComponentType<{ className?: string; strokeWidth?: number }>; href: string }[] = [
  { label: "Dashboard", Icon: Home, href: "/admin/admin-dashboard" },
  { label: "Consultation Management", Icon: CalendarDays, href: "/admin/consultation-management" },
  { label: "Booking Management", Icon: CalendarCheck, href: "/admin/booking-management" },
  { label: "Numerology Management", Icon: LayoutGrid, href: "/admin/numerology-management" },
  { label: "Reiki Management", Icon: HandHeart, href: "/admin/reiki-management" },
  { label: "Pricing Management", Icon: Tag, href: "/admin/pricing-management" },
  { label: "Services Management", Icon: Package, href: "/admin/services-management" },
  { label: "Kundali Management", Icon: Orbit, href: "/admin/kundali-management" },
  ...
  { label: "Astrologers", Icon: UserCog, href: "/admin/admin-dashboard" },
  ...
  { label: "Notifications", Icon: Bell, href: "/admin/admin-dashboard" },
    ...
    <SidebarShell className="bg-gradient-to-b from-[#2a0e46] via-[#1d0733] to-[#160526]">
      ...
      <div className="px-5 pb-3 pt-5">
        <p className="text-center font-display text-[34px] font-bold leading-none tracking-[0.02em] bg-gradient-to-b from-[#f8e2a8] via-[#e9b85c] to-[#c08c2c] bg-clip-text text-transparent">
          AM<span className="text-[42px] leading-none tracking-[-0.04em]">∞</span>
        </p>
        ...
        <Flower2 className="mx-auto mt-1.5 h-[18px] w-[18px] text-[#e9b85c]" strokeWidth={1.5} />

        <div className="mt-2.5 flex items-center justify-center gap-1.5">
          <ShieldCheck className="h-[13px] w-[13px] text-[#e9b85c]" strokeWidth={1.8} />
      ...
      <nav className="flex flex-col gap-[2px] px-3 pb-4">
        {nav.map(({ label, Icon, href }) => {
          ...
          >
            ...
            {active ? (
              <ChevronRight className="h-3.5 w-3.5 shrink-0 text-[#f3c76e]" strokeWidth={2.2} />
            ) : null}
          </Link>
          );
        })}
