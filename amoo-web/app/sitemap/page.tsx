...
const sections: { title: string; links: { label: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Consultation Booking", href: "/consultation/consultation-booking" },
      { label: "Booking Summary", href: "/consultation/booking-summary" },
      { label: "Booking Confirmation", href: "/consultation/booking-confirmation" },
    ],
  },
  {
    title: "Software",
    links: [
      ...
      { label: "Numerology Software", href: "/software-hub/numerology-software" },
    ],
  },
  {
    title: "Dashboards",
    links: [
      { label: "Kundali Dashboard", href: "/user-dashboard/kundali-dashboard" },
      { label: "Numerology Dashboard", href: "/user-dashboard/numerology-dashboard" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "My Consultations", href: "/user-dashboard/consultations-booking" },
      { label: "Kundali Dashboard", href: "/user-dashboard/kundali-dashboard" },
      { label: "My Reports", href: "/user-dashboard/my-reports" },
      { label: "Numerology Dashboard", href: "/user-dashboard/numerology-dashboard" },
      { label: "Other Features", href: "/user-dashboard/other-features" },
      { label: "Payments & Subscription", href: "/user-dashboard/payments-subscription" },
      { label: "Reiki Dashboard", href: "/user-dashboard/reiki-dashboard" },
      { label: "Tarot Dashboard", href: "/user-dashboard/tarot-dashboard" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Consultation Management", href: "/admin/consultation-management" },
      { label: "Kundali Management", href: "/admin/kundali-management" },
      { label: "Numerology Management", href: "/admin/numerology-management" },
