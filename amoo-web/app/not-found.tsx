...
export default function NotFound() {
  return (
    <>
      ...
      <main className="flex min-h-[70vh] flex-col items-center justify-center bg-gradient-to-b from-[#0d0616] to-[#1a0a2e] px-4">
        <div className="text-center">
          <div className="mb-6 font-serif text-[120px] font-bold leading-none text-[#e9b85c] opacity-60">
            404
          </div>
