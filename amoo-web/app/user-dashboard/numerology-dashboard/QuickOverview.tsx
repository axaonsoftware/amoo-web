...
export default function QuickOverview() {
  ...
  const coreNumbers = core.length > 0
    ? core.map((r, i) => ({
        n: String((r.id % 9) + 1),
        circle: ["bg-[#7c3aed]", "bg-[#6d28d9]", "bg-[#eda02f]", "bg-[#ec5f8a]"][i],
        title: r.title,
        sub: r.type,
      }))
    : [
        { n: "3", circle: "bg-[#7c3aed]", title: "Birth Number", sub: "Creative, Optimistic, Social" },
        { n: "7", circle: "bg-[#6d28d9]", title: "Destiny Number", sub: "Spiritual, Analytical, Intuitive" },
        { n: "5", circle: "bg-[#eda02f]", title: "Name Number", sub: "Adventurous, Freedom Loving" },
        { n: "1", circle: "bg-[#ec5f8a]", title: "Personal Year", sub: "New Beginnings, Leadership" },
      ];
    ...
    <section className="rounded-[14px] border border-[#ece9f3] bg-white px-5 py-[16px] shadow-[0_1px_3px_rgba(43,15,71,.04)]">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-[minmax(0,0.74fr)_minmax(0,1fr)]">
        ...
        <div className="rounded-[12px] border border-[#efecf6] bg-[#faf9fc] px-4 py-[18px]">
          <h3 className="text-[13px] font-semibold text-[#2b0f47]">Your Core Numbers</h3>
            ...
            {coreNumbers.map(({ n, circle, title, sub }) => (
              <li key={title} className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-[12.5px] font-semibold text-[#2b0f47]">{title}</p>
                  <p className="mt-[2px] text-[10.5px] leading-[1.4] text-[#8b8697]">{sub}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <div className="rounded-[12px] border border-[#efecf6] bg-white px-4 py-[18px]">
          ...
          <div className="relative mx-auto mt-3 h-[218px] w-full max-w-[420px]">
            ...
            <div className="absolute left-1/2 top-0 w-[190px] -translate-x-1/2 text-center">
              <p className="text-[12px] font-semibold text-[#2b0f47]">Strength</p>
            ...
            <div className="absolute left-0 top-1/2 w-[88px] -translate-y-1/2 text-center">
              ...
              <p className="mt-1.5 text-[12px] font-semibold text-[#2b0f47]">Nature</p>
              <p className="mt-[2px] text-[10.5px] leading-[1.45] text-[#8b8697]">Deep Thinker</p>
            </div>
            ...
            <div className="absolute right-0 top-1/2 w-[96px] -translate-y-1/2 text-center">
              ...
              <p className="mt-1.5 text-[12px] font-semibold text-[#2b0f47]">Career</p>
              <p className="mt-[2px] text-[10.5px] leading-[1.45] text-[#8b8697]">
                Research, Analysis
                <br />
                Spiritual Fields
            ...
            <div className="absolute bottom-0 left-1/2 w-[210px] -translate-x-1/2 text-center">
              <p className="text-[12px] font-semibold text-[#2b0f47]">Life Lesson</p>
              <p className="mt-[2px] text-[10.5px] leading-[1.45] text-[#8b8697]">
