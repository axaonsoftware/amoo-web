...
export default function StatsRow() {
  ...
  const statItems = [
    {
      label: "Total Reports",
      value: String(s.numerology_total ?? 0),
      Icon: FileText,
      iconBg: "bg-[#f1e9fc]",
    ...
    {
      label: "Downloaded",
      value: String(s.numerology_downloaded ?? 0),
      Icon: Download,
      iconBg: "bg-[#fdf0dc]",
    ...
    {
      label: "Favorites",
      value: String(s.numerology_favorites ?? 0),
      Icon: Heart,
      iconBg: "bg-[#fdeaf0]",
      iconColor: "text-[#e0567f]",
    },
    {
      label: "This Year Reports",
      value: String(s.numerology_this_year ?? 0),
      Icon: CalendarDays,
      iconBg: "bg-[#e6f6ea]",
