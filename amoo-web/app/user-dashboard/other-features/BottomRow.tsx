...
const why = [
  { Icon: WhyIcons.Experts, text: "Trusted experts & accurate guidance", strong: false },
  { Icon: WhyIcons.AllInOne, text: "All-in-one spiritual & astrology solution", strong: true },
  { Icon: WhyIcons.Secure, text: "User-friendly & secure platform", strong: true },
  { Icon: WhyIcons.Divine, text: "Empowering your life with divine wisdom", strong: false },
];

const socials = [
  { name: "Instagram", Icon: Brands.Instagram, href: "https://instagram.com/amoooguru" },
  { name: "YouTube", Icon: Brands.YouTube, href: "https://youtube.com/@amoooguru" },
  { name: "Facebook", Icon: Brands.Facebook, href: "https://facebook.com/amoooguru" },
...
export default function BottomRow() {
  return (
    <div className="grid grid-cols-1 gap-[20px] xl:grid-cols-[369fr_191fr_229fr]">
      ...
      <section className={`${cardClass} relative min-h-[202px] overflow-hidden px-[22px] pb-[20px] pt-[19px]`}>
...
Why Users Love {SITE_NAME}?
      ...
      {/* Available On */}
      <section className={`${cardClass} min-h-[202px] px-[35px] pb-[20px] pt-[28px]`}>
      ...
      {/* Stay Connected */}
      <section className={`${cardClass} min-h-[202px] px-[28px] pb-[20px] pt-[26px]`}>
