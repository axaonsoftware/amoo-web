        ...
        <ul className="mt-[14px] flex flex-col">
          {rows.map((r) => {
            ...
            return (
              <li
                key={r.id}
                className="flex flex-wrap items-center gap-x-[16px] gap-y-3 py-[13px]"
              >
                ...
                <div className="flex flex-col items-end">
                  ...
                  <div className="mt-[18px] flex items-center gap-[10px]">
                    <Link
                      href="/user-dashboard/my-reports"
                      className="inline-flex h-[34px] items-center justify-center rounded-[8px] border border-[#e2d5f4] bg-white px-[18px] text-[12.5px] font-medium text-[#6d28d9]"
                    >
                      View
                    </Link>
                    <button
                      ...
                      className="inline-flex h-[34px] w-[34px] items-center justify-center rounded-[8px] border border-[#e2d5f4] bg-white text-[#6d28d9]"
                    >
                      <Download
