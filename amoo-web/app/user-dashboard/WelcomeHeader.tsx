  ...
  return (
    ...
    >
      ...
      {Array.from({ length: 12 }).map((_, i) => (
        <circle
          key={i}
          cx={100 + 71 * Math.cos((i * Math.PI) / 6 - Math.PI / 2)}
          cy={100 + 71 * Math.sin((i * Math.PI) / 6 - Math.PI / 2)}
          r="2.4"
          fill="currentColor"
          opacity=".85"
        />
    ...
    return (
      <div className="flex flex-col items-start gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start gap-3">
          <Flower2
            className="mt-[6px] h-8 w-8 shrink-0 text-[#e0983c]"
            strokeWidth={1.5}
          />
          <div>
            <p className="text-[14px] font-normal text-[#5c5568]">
              Welcome back,
            </p>
            <h1 className="mt-[2px] font-display text-[27px] font-bold leading-none text-[#4a1c7d]">
              Loading...
            </h1>
          </div>
        </div>
    ...
    <div className="flex flex-col items-start gap-5 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2.5 text-[13px] italic text-[#6c6b78]">
            ...
            <span className="not-italic text-[#8054bf]">
              — William Shakespeare
            </span>
          </p>
        </div>
      ...
      <div className="relative w-full shrink-0 overflow-hidden rounded-[14px] bg-gradient-to-r from-[#1c0733] via-[#2a0f47] to-[#3b1665] px-6 py-5 shadow-[0_10px_30px_rgba(42,17,72,.25)] lg:w-[430px]">
        ...
        <div className="relative max-w-[280px]">
          <p className="text-[13px] font-semibold text-[#e9b85c]">
            Today&apos;s Guidance
          </p>
