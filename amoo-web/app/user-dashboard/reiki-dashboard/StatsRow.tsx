...
export default function StatsRow() {
  ...
  const stats = [
    {
      label: "Active Healing Plan",
      value: "Yes",
      valueSize: "text-[22px]",
      sub: "Reiki Healing Plan",
      link: "View Plan",
      Icon: LotusGlyph,
      iconBg: "bg-[#f1e9fc]",
    ...
    },
    {
      ...
      value: upcomingReiki
        ? new Date(upcomingReiki.date).toLocaleDateString("en-IN", {
            day: "numeric",
            month: "short",
            year: "numeric",
          })
        : "None scheduled",
      valueSize: "text-[17px]",
      sub: upcomingReiki?.time?.slice(0, 5) || "",
      link: "View Details",
      Icon: CalendarDays,
      iconBg: "bg-[#fdf0dc]",
    ...
    },
    {
      ...
      value: String(completedSessions || totalReiki),
      valueSize: "text-[22px]",
      link: "View History",
      Icon: Leaf,
      iconBg: "bg-[#e6f6ea]",
    ...
    },
    {
      ...
      value:
        completedSessions > 0
          ? `${Math.min(completedSessions, 30)} Days`
          : "0 Days",
      valueSize: "text-[22px]",
      link: "Keep Going!",
      Icon: HeartPulse,
    ...
    },
    {
      ...
      value:
        completedSessions > 0
          ? `${Math.min(Math.round(completedSessions * 8.5), 100)}%`
          : "—",
      valueSize: "text-[22px]",
      sub: completedSessions > 5 ? "Good Balance" : "Getting Started",
      Icon: Star,
      iconBg: "bg-[#fdf0dc]",
      iconColor: "text-[#e0a63a]",
    },
  ];
  ...
  return (
    <div className="mt-4 grid grid-cols-1 gap-[14px] sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
      {stats.map(
        ({ label, value, valueSize, sub, link, Icon, iconBg, iconColor }) => (
          <div
            key={label}
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-[12.5px] font-medium text-[#6c6b78]">
                {label}
              </p>
              <p
              ...
              {sub ? (
                <p className="mt-1.5 text-[11px] text-[#8b8697]">{sub}</p>
              ) : null}
              {link ? (
                <button
                  type="button"
