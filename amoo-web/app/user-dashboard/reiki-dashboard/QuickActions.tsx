...
import { CalendarPlus, FileText, NotebookPen, Music, Heart } from "lucide-react";
...
export default function QuickActions() {
  return (
    <section className="rounded-[14px] border border-[#ece9f3] bg-white px-5 py-[18px] shadow-[0_1px_3px_rgba(43,15,71,.04)]">
      <h2 className="font-display text-[17px] font-bold text-[#2b0f47]">Quick Actions</h2>
      ...
      <div className="mt-3.5 grid grid-cols-3 gap-2.5">
        {actions.map(({ label, Icon, iconBg, iconColor }) => (
          ...
          >
            ...
            <span className="text-[10.5px] font-medium leading-[1.3] text-[#3d3a48]">{label}</span>
          </button>
        ))}
      </div>
    </section>
