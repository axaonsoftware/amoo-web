...
function BookingForm() {
  ...
  const handleBack = () => {
    router.push(
      `/consultation/select-date-time?service=${encodeURIComponent(service)}&mode=${encodeURIComponent(mode)}`,
    );
  };
      ...
      <main id="main-content" className="flex-1 bg-cream">
          ...
          <div className="mx-auto max-w-[1100px] px-3 sm:px-5 py-5 sm:py-7">
            <div className="flex items-start justify-between">
              {STEPS.map((step, i) => (
                <div
                  key={step.num}
                  className="flex flex-1 flex-col items-center relative min-w-0"
                >
                  {/* Connector line */}
                  {i > 0 && (
                    <span
        ...
        <div className="mx-auto max-w-[1100px] px-5 pt-8 pb-2">
          ...
          <div className="mx-auto mt-5 flex max-w-[680px] items-center justify-center gap-2 rounded-lg bg-[#fdf6e3] py-3 px-4 text-[13px] text-[#8b6914]">
            ...
            Your information is 100% secure and confidential. We respect your
            privacy.
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <section className="rounded-xl border border-line bg-white p-6">
                <div className="mb-5 flex items-center gap-2.5">
                  ...
                  <h2 className="text-[17px] font-semibold text-grape">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="h-[44px] w-full appearance-none rounded-lg border border-line bg-white pl-4 pr-10 text-[13.5px] text-body focus:border-grape-2 focus:outline-none focus:ring-1 focus:ring-grape-2/30"
                      >
                  ...
                  <div>
                    <label
                      htmlFor="page-marital-status-optional"
                      className="mb-1.5 block text-[13px] font-medium text-ink"
                    >
                      Marital Status{" "}
                    ...
                    <div className="relative">
                      <select
                        id="page-marital-status-optional"
                        value={maritalStatus}
              ...
              <section className="rounded-xl border border-line bg-white p-6">
                ...
                {/* Selected Service */}
                <div className="mb-4">
                  <p className="mb-2 block text-[13px] font-medium text-ink">
                    Selected Service
                  </p>
                  <div className="flex items-center gap-4 rounded-xl border border-line bg-[#fdfaf5] p-4">
                    ...
                    <div className="flex-1">
                      <p className="text-[14.5px] font-semibold text-grape">
                        {service}
                      </p>
                    ...
                    <span className="text-[18px] font-bold text-grape">
                      {price}
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-line bg-[#fdfaf5] p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-[11.5px] text-body">
                          Guidance with our expert via {mode}.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-line bg-[#fdfaf5] p-4">
                      ...
                      <button
                        type="button"
                        className="text-[13px] font-medium text-grape-2 underline underline-offset-2"
                      >
                        Change
                      </button>
                    </div>
                  ...
                  <div>
                    <label
                      htmlFor="page-preferred-language-optional"
                      className="mb-1.5 block text-[13px] font-medium text-ink"
                    >
                      Preferred Language{" "}
                      <span className="text-body">(Optional)</span>
                    ...
                    <div className="relative">
                      <select
                        id="page-preferred-language-optional"
                        value={language}
              ...
              <section className="rounded-xl border border-line bg-white p-6">
                ...
                />
                <p className="mt-1.5 text-right text-[12px] text-body">
              ...
              <section className="rounded-xl border border-line bg-white p-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <label
                      htmlFor="page-upload-birth-chart-relevant"
                      className="mb-1.5 block text-[13px] font-medium text-ink"
                    >
                      Upload Birth Chart / Relevant Documents{" "}
                      <span className="text-body">(Optional)</span>
                    </label>
                    <input
                      id="page-upload-birth-chart-relevant"
                      ref={fileInputRef}
                      type="file"
                    ...
                    {uploadedFile ? (
                      ...
                      >
                        ...
                        <p className="mt-2 text-[12.5px] text-ink">
                          <span className="font-medium text-grape-2">
                            Click to upload
                          </span>{" "}
                          or drag and drop
                        </p>
                  ...
                  <div>
                    <label
                      htmlFor="page-special-requests-optional"
                      className="mb-1.5 block text-[13px] font-medium text-ink"
                    >
                      Special Requests{" "}
                      <span className="text-body">(Optional)</span>
                    ...
                    <textarea
                      id="page-special-requests-optional"
                      rows={4}
                ...
                >
                  ...
                  <span className="text-[13px] leading-[1.5] text-ink">
                    I confirm that the above information is correct and I want
                    to proceed with booking this consultation.
                  </span>
                </label>
                {errors.agree && (
            ...
            <div className="lg:sticky lg:top-6 lg:self-start">
              <div className="overflow-hidden rounded-xl border border-line bg-white shadow-[0_2px_16px_rgba(75,37,131,0.07)]">
                ...
                <div className="relative bg-gradient-to-br from-royal to-ink px-5 pt-5 pb-0">
                  <h3 className="text-center text-[18px] font-bold text-gold">
                ...
                <div className="px-5 py-5">
                  {/* Service Details */}
                  <h4 className="mb-3 text-[14px] font-semibold text-grape">
                    Service Details
                  </h4>
                  <div className="mb-4 flex items-start gap-3 rounded-lg bg-[#fdfaf5] p-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-[11.5px] leading-[1.5] text-body">
                        Selected consultation service
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="flex h-[18px] w-[18px] shrink-0 items-center justify-center text-[14px] font-bold text-grape-2">
                        ₹
                      </span>
                      <span className="flex-1 text-[12.5px] text-body">
                        Price
                      </span>
                      <span className="text-[14px] font-bold text-grape">
                        {price}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[16px] font-semibold text-grape">
                      Total Amount
                    </span>
                    <span className="text-[22px] font-bold text-grape">
                      {total}
                    </span>
                  </div>
                  ...
                  <div className="mb-4 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[13px] font-semibold text-grape">
                        100% Secure Booking
                      </p>
                      <p className="mt-0.5 text-[11.5px] leading-[1.5] text-body">
                        Your transaction and personal details are safe with us.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-[11.5px] leading-[1.5] text-body">
                        Our support team is here to assist you anytime you need.
                      </p>
                    </div>
                  </div>
