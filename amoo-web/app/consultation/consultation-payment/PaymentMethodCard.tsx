...
function QrPlaceholder() {
  return (
    <svg viewBox="0 0 100 100" width="90%" height="90%">
      ...
      <rect x="0" y="0" width="24" height="24" fill="none" stroke="#150b21" strokeWidth="4" />
      <rect x="76" y="0" width="24" height="24" fill="none" stroke="#150b21" strokeWidth="4" />
      <rect x="0" y="76" width="24" height="24" fill="none" stroke="#150b21" strokeWidth="4" />
      <circle cx="50" cy="50" r="10" fill="white" stroke="#5B2A9D" strokeWidth="2" />
      <text x="50" y="54" textAnchor="middle" fontSize="10" fill="#5B2A9D" fontWeight="bold">
        A
      </text>
    </svg>
  );
  ...
  return (
    <span className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center text-xs font-semibold">
      <svg width="16" height="16" viewBox="0 0 48 48">
        ...
        <path fill="#FBBC05" d="M11.69 28.18A13.9 13.9 0 0 1 10.9 24c0-1.45.25-2.86.7-4.18v-5.7H4.34A21.93 21.93 0 0 0 2 24c0 3.55.85 6.91 2.34 9.88l7.35-5.7z" />
...
function PhonePeBadge() {
  return (
    <span className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-bold" style={{ background: "#5F259F" }}>
      Pe
    </span>
  );
}
function PaytmBadge() {
  return (
    <span className="text-xs font-semibold text-[#00B9F1]">
      Paytm
    </span>
  );
}
function BhimBadge() {
  return (
    <p className="text-xs font-semibold text-orange-600 mt-2">BHIM</p>
  );
}
