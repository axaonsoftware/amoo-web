...
export function TarotCardIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <rect x="6" y="4" width="20" height="28" rx="3" fill="#4b2583" opacity="0.3" />
      <rect x="10" y="2" width="20" height="28" rx="3" fill="#6b3fa0" opacity="0.5" />
      <rect x="14" y="0" width="20" height="28" rx="3" fill="#e9b85c" opacity="0.9" />
      <path d="M24 8l1.5 3 3.3.5-2.4 2.3.6 3.2-3-1.6-3 1.6.6-3.2-2.4-2.3 3.3-.5Z" fill="#4b2583" />
    </svg>
  );
}
...
export function HeartIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <path d="M20 34c-6 0-11-3.6-11-8.2 0-3.4 2.2-6 5.2-7.4.6-.3 1.2-.4 1.6-.1.4.2.6.7.5 1.2-.3 1.2-.1 2.4.6 3.4 1.4 2 4.4 2 5.8 0 .7-1 .9-2.2.6-3.4-.1-.5.1-1 .5-1.2.4-.3 1-.2 1.6.1 3 1.4 5.2 4 5.2 7.4 0 4.6-5 8.2-11 8.2Z" fill="#e9b85c" />
    </svg>
  );
}
...
export function BriefcaseIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <rect x="6" y="14" width="28" height="18" rx="3" fill="#e9b85c" opacity="0.9" />
      <path d="M14 14V10a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v4" fill="none" stroke="#e9b85c" strokeWidth="2.5" />
...
export function CoinIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      ...
      <circle cx="20" cy="20" r="10" fill="none" stroke="#4b2583" strokeWidth="1.5" />
      <text x="20" y="25" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#4b2583">₹</text>
    </svg>
  );
}
...
export function YesNoIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      ...
      <text x="14" y="24" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#4b2583">Y</text>
      <text x="26" y="24" textAnchor="middle" fontSize="10" fontWeight="bold" fill="white">N</text>
    </svg>
  );
}
...
export function CalendarCardIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      ...
      <text x="20" y="30" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#4b2583">2026</text>
    </svg>
  );
}
...
export function ThreeCardIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <rect x="2" y="6" width="14" height="20" rx="2" fill="#6b3fa0" opacity="0.6" />
      <rect x="13" y="4" width="14" height="20" rx="2" fill="#e9b85c" opacity="0.9" />
      <rect x="24" y="6" width="14" height="20" rx="2" fill="#4b2583" opacity="0.7" />
      <text x="20" y="18" textAnchor="middle" fontSize="8" fontWeight="bold" fill="white">3</text>
    </svg>
  );
}
...
export function OneCardIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <rect x="10" y="4" width="20" height="28" rx="3" fill="#e9b85c" opacity="0.9" />
      <path d="M20 10l1.5 3 3.3.5-2.4 2.3.6 3.2-3-1.6-3 1.6.6-3.2-2.4-2.3 3.3-.5Z" fill="#4b2583" />
    </svg>
  );
}
...
export function SpiritualIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <circle cx="20" cy="20" r="14" fill="#e9b85c" opacity="0.9" />
      <circle cx="20" cy="20" r="8" fill="none" stroke="#4b2583" strokeWidth="1.5" />
...
export function SpreadIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="currentColor" className={className}>
      <rect x="2" y="8" width="12" height="18" rx="2" fill="#6b3fa0" opacity="0.5" transform="rotate(-15 8 17)" />
      <rect x="10" y="6" width="12" height="18" rx="2" fill="#e9b85c" opacity="0.9" />
      <rect x="18" y="8" width="12" height="18" rx="2" fill="#4b2583" opacity="0.7" transform="rotate(15 24 17)" />
    </svg>
  );
}

export const TAROT_ICON_MAP: Record<string, React.FC<{ className?: string }>> = {
