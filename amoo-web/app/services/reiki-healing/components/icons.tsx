...
export function SparkleIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path d="M12 10c.4 2.6 1.4 4.2 3.1 5.2-1.7 1-2.7 2.6-3.1 5.2-.4-2.6-1.4-4.2-3.1-5.2 1.7-1 2.7-2.6 3.1-5.2Z" opacity="0.65" />
...
export function ArrowFlourish({ flip = false, className = "" }: { flip?: boolean; className?: string }) {
  return (
    <span
      aria-hidden
      className={`hidden items-center gap-1.5 text-gold sm:flex ${flip ? "flex-row-reverse" : ""} ${className}`}
    >
      <svg viewBox="0 0 14 12" fill="currentColor" className="h-[10px] w-[12px] shrink-0">
...
export function ChakraBalancingIcon(props: IconProps) {
  return (
    <svg {...line} {...props}>
      ...
      <path d="m6.1 6.1 2.4 2.4M15.5 15.5l2.4 2.4M17.9 6.1l-2.4 2.4M8.5 15.5l-2.4 2.4" opacity="0.7" />
    </svg>
  );
}
...
export function EnergyClearingIcon(props: IconProps) {
  return (
    <svg {...line} {...props}>
      ...
      <path d="M18.2 15.4l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8Z" opacity="0.75" />
      <path d="M5 15.6l.6 1.6 1.6.6-1.6.6-.6 1.6-.6-1.6L2.8 18l1.6-.6Z" opacity="0.6" />
    </svg>
  );
}
...
export function PersonalHealingIcon(props: IconProps) {
  return (
    <svg {...line} strokeWidth={1.3} {...props}>
      <path d="M12 2.8v3.6M9.2 4l1 2.6M14.8 4l-1 2.6M6.6 6.6l1.9 2M17.4 6.6l-1.9 2" opacity="0.8" />
...
export function EmotionalHeartIcon(props: IconProps) {
  return (
    <svg {...line} strokeWidth={1.3} {...props}>
      ...
      <path d="M4.4 18.8c1.6-1 3.4-1.5 5.2-1.5M19.6 18.8c-1.6-1-3.4-1.5-5.2-1.5" opacity="0.75" />
...
export function RelationshipIcon(props: IconProps) {
  return (
    <svg {...line} strokeWidth={1.3} {...props}>
      ...
      <path d="M3.2 20.6c1-2 2.6-3.2 4.4-3.6M20.8 20.6c-1-2-2.6-3.2-4.4-3.6" opacity="0.75" />
    </svg>
  );
}
...
export function StepHealingIcon(props: IconProps) {
  return (
    <svg {...line} strokeWidth={1.3} {...props}>
      ...
      <path d="M12 3.4v1.4M12 11.6V13M7.4 8.2H8.8M15.2 8.2h1.4M8.7 4.9l1 1M14.3 11.5l1 1M15.3 4.9l-1 1M9.7 11.5l-1 1" opacity="0.8" />
