...
export default function AdminResetPasswordForm() {
  ...
  useEffect(() => {
    const updateTimer = () => {
      const expiresAt = Number(
        sessionStorage.getItem("admin_reset_otp_expires_at") || 0,
      );
      ...
      if (remaining === 0) {
        sessionStorage.removeItem("admin_reset_otp_expires_at");
      }
    };
  ...
  async function handleResendOtp() {
    if (!email.trim() || resendLoading || otpRemainingSeconds > 0) {
      return;
    }
    ...
    try {
      ...
      sessionStorage.setItem("admin_reset_otp_expires_at", String(expiresAt));
    ...
    return (
      <div className="flex flex-col items-center px-10 pt-12 pb-10 text-center">
        ...
        >
          ...
          <span>
            Your admin account password has been reset successfully. Please
    ...
    <div className="flex flex-col items-center px-6 sm:px-10 md:px-14 pt-10 sm:pt-12 pb-8 sm:pb-10">
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="flex-1 h-px bg-gray-200" />ss
        </div>
