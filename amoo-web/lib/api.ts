...
export const api = {
  ...
  expertForgotPassword: (body: { email: string }) =>
    request("POST", "/api/auth/expert/forgot-password", body),

  expertResetPassword: (body: {
    email: string;
    otp: string;
    password: string;
  }) =>
    request("POST", "/api/auth/expert/reset-password", body),

  adminForgotPassword: (body: { email: string }) =>
    request("POST", "/api/auth/admin/forgot-password", body),
  ...
  adminResetPassword: (body: {
    ...
    request("POST", "/api/auth/admin/reset-password", body),
