...
function cspWithNonce(nonce: string) {
  return [
    ...
    "img-src 'self' data: blob: http://localhost:4000 https://images.unsplash.com https://upload.wikimedia.org https://res.cloudinary.com", "font-src 'self' data: https://fonts.gstatic.com",
