...
async function seed() {
  ...
  // Services
  const services = [
    ["Numerology Report", "Complete life path analysis", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/name_numerology.png", "Numerology", "Report", 999, "Instant", "Active", 325],
    ["Tarot Reading", "3 Card Spread", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/tarot_reading.png", "Tarot", "Consultation", 799, "30 mins", "Active", 286],
    ["Kundli Reading", "Vedic Birth Chart Analysis", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/kundli_generator.png", "Astrology", "Consultation", 1499, "60 mins", "Active", 412],
    ["Reiki Healing Session", "Distance Healing Therapy", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/reiki_healer.png", "Healing", "Consultation", 999, "45 mins", "Active", 198],
    ["Vastu Consultation", "Home & Office Vastu", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/vastu_analyzer.png", "Vastu", "Consultation", 1299, "60 mins", "Active", 167],
    ["AI Astro Chat", "Ask Any Astrology Question", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/ai_astro_chat.png", "AI Services", "Chat", 199, "Per Chat", "Active", 642],
    ["Past Life Reading", "Past Life Analysis", "https://res.cloudinary.com/iguqsxhj/image/upload/amoo/imagesP/past_life_analysis.png", "Spiritual", "Report", 1199, "Instant", "Inactive", 54],
